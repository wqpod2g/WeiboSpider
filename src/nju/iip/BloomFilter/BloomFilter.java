...
// A Bloom Flter is a space-ecient representation of a set or a list that
...
public class BloomFilter<T>
{
  ...
  public final int[] ERROR_RATE_1024 =
  {                                          // m/n
    //k = 1    2    3    4    5   6   7   8  //
  ...
  {
	  if(!bfFile.exists())
		  throw new IllegalArgumentException("bloomFilter:"+bfFile.getName());
  ...
  public int findIndex(int errorRate1024, int k)
  {
    if ((k != 0) && ((k < 2) || (k > 9)))
       return -1;
